        ...
        <div className="popup-container">
          <div className="popup-content">
            ...
            <div className="d-flex gap-2 align-items-center">
              <Link href="#">
                <img
                  src="/imgs/template/popup/logo.png"
                  alt="Travila"
                  width={80}
                  height={42}
                />
            ...
            <div className="box-button-logins">
              <Link className="btn btn-login btn-google mr-10" href="#">
                <img src="/imgs/template/popup/google.svg" alt="Travila" />
                <span className="text-sm-bold">Sign up with Google</span>
              </Link>
              <Link className="btn btn-login mr-10" href="#">
                <img src="/imgs/template/popup/facebook.svg" alt="Travila" />
              </Link>
              <Link className="btn btn-login" href="#">
                <img src="/imgs/template/popup/apple.svg" alt="Travila" />
              </Link>
            </div>
