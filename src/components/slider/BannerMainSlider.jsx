  ...
  return (
    <>
      ...
      <div className="slider-thumnail">
        ...
        >
          <div className="banner-slide">
            <img src="/assets/imgs/page/homepage2/thumb.png" alt="Travila" />
          </div>
          <div className="banner-slide">
            <img src="/assets/imgs/page/homepage2/thumb2.png" alt="Travila" />
          </div>
          <div className="banner-slide">
            <img src="/assets/imgs/page/homepage2/thumb3.png" alt="Travila" />
          </div>
          <div className="banner-slide">
            <img src="/assets/imgs/page/homepage2/thumb.png" alt="Travila" />
          </div>
