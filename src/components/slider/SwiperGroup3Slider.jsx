        ...
        <SwiperSlide>
          <div className="card-news background-card hover-up">
            <div className="card-image">
              ...
              <img src="/imgs/page/homepage1/news.png" alt="Travila" />
            </div>
            <div className="card-info">
              ...
              <div className="card-title">
                {" "}
                <Link className="text-xl-bold neutral-1000" to="/blog-detail">
              ...
              <div className="card-program">
                <div className="endtime">
                  <div className="card-author">
                    {" "}
                    <img src="/imgs/page/homepage1/avatar.png" alt="Travila" />
        ...
        <SwiperSlide>
          <div className="card-news background-card hover-up">
            <div className="card-image">
              ...
              <img src="/imgs/page/homepage1/news2.png" alt="Travila" />
            </div>
            <div className="card-info">
              <div className="card-meta">
                {" "}
        ...
        <SwiperSlide>
          <div className="card-news background-card hover-up">
            <div className="card-image">
              ...
              <img src="/imgs/page/homepage1/news3.png" alt="Travila" />
            </div>
            <div className="card-info">
              <div className="card-meta">
                {" "}
