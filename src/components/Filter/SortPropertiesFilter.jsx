      ...
      <div className="row align-items-center">
        <div className="col-xl-4 col-md-4 mb-10 text-lg-start text-center">
          <div className="box-view-type">
            <Link className="display-type display-grid active" to="/tour-grid">
              <svg
                width={22}
                height={22}
                viewBox="0 0 22 22"
            ...
            <Link className="display-type display-list" to="/tour-list">
              <svg
                width={21}
                height={21}
                viewBox="0 0 21 21"
            ...
            <div className="item-sort border-1">
              ...
              {/* <Dropdown className="dropdown dropdown-sort border-1-right">
								...
								<Dropdown.Menu as="ul" className="dropdown-menu dropdown-menu-light" aria-labelledby="dropdownSort" style={{ margin: 0 }}>
									<li><Link className="dropdown-item active" to="#">Most Viewed</Link></li>
									<li><Link className="dropdown-item" to="#">Recently search</Link></li>
									<li><Link className="dropdown-item" to="#">Most popular</Link></li>
									<li><Link className="dropdown-item" to="#">Top rated</Link></li>
								</Dropdown.Menu>
							</Dropdown> */}
