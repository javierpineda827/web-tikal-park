      ...
      <section className="section-box box-testimonials-2 box-testimonials-6 background-body">
        <div className="container">
          <div className="text-center wow fadeInUp">
            ...
            <h4 className="mt-8 mb-5 neutral-1000 text-word-break">
              Lo que dicen nuestros clientes
            </h4>
          </div>
          <div className="box-img-test-1">
            {" "}
            <img src="/imgs/page/homepage10/img-test.png" alt="Travila" />
          </div>
          <div className="box-img-test-2">
            <img src="/imgs/page/homepage10/img-test2.png" alt="Travila" />
          </div>
          <div className="box-img-test-3">
            {" "}
            <img src="/imgs/page/homepage10/img-test3.png" alt="Travila" />
          </div>
          <div className="box-img-test-4">
            {" "}
            <img src="/imgs/page/homepage10/img-test4.png" alt="Travila" />
          </div>
                      ...
                      <div className="card-testimonial card-testimonial-2">
                        ...
                        <div className="card-info">
                          <p className="neutral-1000 text-md">
                            Llevo varios años utilizando el sistema de reservas
                            de hoteles, y se ha convertido en mi plataforma de
                            referencia para planificar mis viajes. La interfaz
                            es fácil de usar, y aprecio la disponibilidad de
                            información detallada de los hoteles.
                          </p>
                        </div>
                        <div className="card-bottom">
                          <p className="text-sm-bold neutral-1000">
                            --- Presupuesto Explorer ---
                          </p>
                        </div>
                      </div>
                    </SwiperSlide>
