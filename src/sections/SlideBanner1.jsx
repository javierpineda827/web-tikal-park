                ...
                <SwiperSlide>
                  <div className="card-banner-slide card-banner-slide-2 wow fadeInUp">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/imgs/page/homepage4/bg-slider2.jpg)",
                      }}
                    />
                    <div className="card-info">
                      <p className="text-md-bold text-white">Limited Offers</p>
                ...
                <SwiperSlide>
                  <div className="card-banner-slide card-banner-slide-3 wow fadeInUp">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/imgs/page/homepage4/bg-slider3.jpg)",
                      }}
                    />
                    <div className="card-info">
                ...
                <SwiperSlide>
                  <div className="card-banner-slide card-banner-slide-2 wow fadeInUp">
                    <div
                      ...
                      style={{
                        backgroundImage:
                          "url(assets/imgs/page/homepage4/bg-slider8.jpg)",
                      }}
                    />
                    <div className="card-info">
                      <p className="text-md-bold text-white">Limited Offers</p>
