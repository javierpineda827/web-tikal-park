...
export default function BlogHydrology() {
  return (
    <>
        ...
        <main className="main">
              ...
              <ul className="breadcrumbs">
                ...
                <li>
                  ...
                  <span className="text-breadcrumb">
                    Hidrología del Parque Nacional Tikal en Guatemala
                  </span>
                </li>
              </ul>
            </div>
          ...
          <section className="box-section box-content-blog-detail background-body">
            <div className="container-banner-blog-detail">
              {" "}
              <img src="/imgs/page/hydrology/Background03.jpg" alt="Travila" />
            </div>
            <div className="container">
                ...
                <div className="box-content-info-detail">
                  ...
                  <div className="content-detail-post">
                    <p className="neutral-1000">
                      <h6>La Meteorológica de Tikal</h6>
                      La región central de El Petén está dominada por colinas
                      bajas de roca caliza que datan del período Oligoceno*, lo
                      cual explica la cantidad limitada de cuerpos de agua
                      permanentes en la superficie, aún durante la temporada de
                      lluvias hay pocos arroyos.
                    </p>
                    <p>
                      {" "}
                      La mayor parte del agua que se consume en Tikal en tiempos
                      modernos es traída al parque en camiones cisterna desde el
                      Lago Petén Itzá, el cuerpo de agua más grande en la
                      Península de Yucatán, a 33 kilómetros al sur del parque,
                      pues el lago es la única fuente de agua permanente en las
                      cercanías. Muy pocos aljibes o depósitos se encuentran en
                      servicio en Tikal. Ésta es una de las razones para cuidar
                      el uso del agua durante tu visita a Tikal.
                    </p>
                  </div>
