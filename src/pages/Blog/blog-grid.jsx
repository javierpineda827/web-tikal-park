                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                              {" "}
                              <Link className="text-sm-bold" to="#">
                                Wanderlust
                              </Link>
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity2.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity3.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity4.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity5.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity6.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity7.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                        ...
                        <SwiperSlide>
                          <div className="card-popular-destination card-popular-destination-type-2">
                            <div className="card-image">
                              {" "}
                              <img
                                src="/imgs/page/homepage5/activity8.png"
                                alt="Travila"
                              />
                            </div>
                            <div className="card-info">
                  ...
                  <Swiper {...swiperGroupCenter4}>
                    <SwiperSlide>
                      <div className="card-blog">
                        <div className="card-image">
                          <img src="/imgs/page/blog/blog.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-blog">
                        <div className="card-image">
                          <img src="/imgs/page/blog/blog2.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-info-blog">
                            <Link
                            ...
                            <Link className="card-title heading-5" to="#">
                              Savoring Life’s Palette: Art, Food, and Beyond
                            </Link>
                            <div className="card-meta-user">
                              <div className="box-author-small">
                    ...
                    <SwiperSlide>
                      <div className="card-blog">
                        <div className="card-image">
                          <img src="/imgs/page/blog/blog3.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-info-blog">
                            <Link
                    ...
                    <SwiperSlide>
                      <div className="card-blog">
                        <div className="card-image">
                          <img src="/imgs/page/blog/blog4.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-info-blog">
                            <Link className="btn btn-label-tag" to="#">
                              Cultural
                            </Link>
                            <Link
                              className="card-title heading-5"
          ...
          <section className="box-section box-buttons-destination box-buttons-blog background-body">
            <div className="container">
              <div className="box-button-faq wow fadeInRight">
                {" "}
                <Link className="btn btn-border-1" to="#">
                  <svg
                    width={25}
                    height={24}
                    viewBox="0 0 25 24"
                  ...
                  <div className="box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn">
                    <div className="card-flight card-news background-card">
                      <div className="card-image">
                        ...
                        <Link to="/blog-detail">
                          <img src="/imgs/page/blog/news.png" alt="Travila" />
                        </Link>
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="btn btn-label-tag background-1" to="#">
                          Adventure
                        </Link>
                        ...
                        <div className="card-program">
                          <div className="endtime">
                            <div className="card-button">
                              {" "}
                              <Link className="btn btn-gray" to="/blog-detail">
                                Keep Reading
                              </Link>
                            </div>
                          </div>
                    ...
                    <div className="card-flight card-news background-card">
                      <div className="card-image">
                        ...
                        <Link to="/blog-detail">
                          <img src="/imgs/page/blog/news2.png" alt="Travila" />
                        </Link>
                      </div>
                      <div className="card-info">
                        {" "}
                    ...
                    <div className="card-flight card-news background-card">
                      <div className="card-image">
                        ...
                        <Link to="/blog-detail">
                          <img src="/imgs/page/blog/news3.png" alt="Travila" />
                        </Link>
                      </div>
                      <div className="card-info">
                        {" "}
                    ...
                    <div className="card-flight card-news background-card">
                      <div className="card-image">
                        ...
                        <Link to="/blog-detail">
                          <img src="/imgs/page/blog/news4.png" alt="Travila" />
                        </Link>
                      </div>
                      <div className="card-info">
                        {" "}
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/blog-detail">
                                <img
                                  src="/imgs/page/blog/trending.png"
                                  alt="Travila"
                                />
                              </Link>
                            </div>
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/blog-detail">
                                <img
                                  src="/imgs/page/blog/trending2.png"
                                  alt="Travila"
                                />
                              </Link>
                            </div>
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/blog-detail">
                                <img
                                  src="/imgs/page/blog/trending3.png"
                                  alt="Travila"
                                />
                              </Link>
                            </div>
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/blog-detail">
                                <img
                                  src="/imgs/page/blog/trending4.png"
                                  alt="Travila"
                                />
                              </Link>
                            </div>
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/blog-detail">
                                <img
                                  src="/imgs/page/blog/trending5.png"
                                  alt="Travila"
                                />
                              </Link>
                            </div>
                    ...
                    <div className="box-content-sidebar">
                      <ul className="list-photo-col-3">
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat2.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat3.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat4.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat5.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat6.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat7.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
                          <Link to="#">
                            <img src="/imgs/page/blog/cat8.png" alt="Travila" />
                          </Link>
                        </li>
                        <li>
                          {" "}
