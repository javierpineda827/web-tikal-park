...
export default function BlogMayas() {
  return (
    <>
        ...
        <main className="main">
          ...
          <section className="box-section box-content-blog-detail background-body">
            <div className="container-banner-blog-detail">
              {" "}
              <img src="/imgs/page/mayas/banner1.jpg" alt="Travila" />
            </div>
            <div className="container">
                ...
                <div className="box-content-info-detail">
                  ...
                  <div className="content-detail-post">
                    <p className="neutral-1000">
                      Los colonos que llegaron a Tikal alrededor del año 800
                      A.C. se establecieron sobre una colina, en donde
                      comenzaron a construir sus edificios y su impresionante
                      centro ceremonial. Tikal fue una ciudad-estado
                      independiente, que floreció por más de mil años, ocupaba
                      una posición prominente entre varias ciudades-estado de la
                      región. Sin embargo, aún cuando cada ciudad fuera
                      independiente, les unían una herencia cultural en común y
                      sus actividades comerciales. En todo el Mundo Maya hubo un
                      conocimiento compartido y una religión en común. Para
                      aprender más sobre el arte y la religión de los Mayas, así
                      como sobre sus técnicas agrícolas y sus rutas de comercio,
                      sus matemáticas y su escritura jeroglífica, oprima por
                      favor los siguientes links:
                    </p>
                  </div>
                  <div className="box-image-video container-sm">
                    ...
                    <figure>
                      <img
                        src="/imgs/page/mayas/temple1.jpg"
                        alt="Travilla"
                        style={{ objectFit: "contain", height: "28rem" }}
                      />
                      <figcaption className="text-muted mt-2">{""}</figcaption>
                    </figure>
                    <VideoPopup
                      vdocls="btn-play-video popup-youtube"
                      url_video={"Xv-JwjMQPOs"}
                    />
                  </div>
                  <div className="content-detail-post">
                    <div className="container-sm mx-auto my-5">
                      <ul className="d-flex flex-wrap justify-content-center align-items-center gap-5 ">
                        <li>
                          <Link
                            className="btn btn-label-tag-lg background-1"
                            to="/arts"
                          >
                            Arte
                          </Link>
                        ...
                        <li>
                          <Link
                            className="btn btn-label-tag-lg background-3"
                            to="#"
                          >
                            Religión
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            href="#"
                          >
                            <small className="text-sm fw-semibold">
                        ...
                        <li>
                          <Link
                            className="btn btn-label-tag-lg background-4"
                            href="#"
                          >
                            <small className="text-sm fw-semibold">
                        ...
                        <li>
                          <Link
                            className="btn btn-label-tag-lg background-5"
                            to="#"
                          >
                            <small className="text-sm fw-semibold">
                    ...
                    <h6 id="religion">
                      Religion y Sistema de Creencias de los Antiguos Mayas{" "}
                    </h6>
