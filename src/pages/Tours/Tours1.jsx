        ...
        <main className="main">
          <section className="box-section box-breadcrumb background-body">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  {" "}
                  <Link to="/destination-4">Destinations</Link>
                  <span className="arrow-right">
                    <svg
                      width={7}
                      height={12}
                ...
                <li>
                  {" "}
                  <Link to="/destination-4">America Central</Link>
                  <span className="arrow-right">
                    <svg
                      width={7}
                      height={12}
          ...
          <section className="box-section box-banner-destination box-banner-destination-5 background-body">
            <div className="box-banner-2-col">
              <div className="banner-destination container mx-auto">
                <div className="box-swiper">
                  <div className="swiper-container swiper-group-1">
                    <Swiper {...swiperGroup1}>
                      <SwiperSlide>
                        <img
                          src="/imgs/page/tour/SecondSection.jpg"
                          alt="Travile"
                          style={{
                      ...
                      <SwiperSlide>
                        <img
                          src="/imgs/page/tour/Highland tour.jpg"
                          alt="Travile"
                        />
                      </SwiperSlide>
                      <SwiperSlide>
                        <img src="/imgs/page/tour/image013.jpg" alt="Travile" />
                      </SwiperSlide>
                    </Swiper>
                  </div>
              ...
              {/* <div className="banner-destination-right">
                <div className="map-main">
                  <img
                    src="/imgs/page/tour/image013.jpg"
                    style={{
                      objectFit: "cover",
                      objectPosition: "center",
                      width: "100",
            ...
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <h2 className="neutral-1000">El Mirador Helitour</h2>
                  ...
                  <p className="text-xl-medium neutral-1000 mt-55 mb-45">
                    Únase a nuestros tours en helicóptero y vaya a El Mirador y
                    más allá para descubrir más misterios en las profundidades
                    de la selva Maya. Tours privados en helicóptero de El
                    Mirador están disponibles durante todo el año. A lo largo
                    del año también hay una serie de oportunidades especiales...
                  </p>
                  <div className="box-buttons d-flex align-items-center flex-wrap">
                    {" "}
                    <Link className="btn btn-black-lg mr-10 mb-15" to="#">
                    ...
                    <Link className="btn btn-brand-secondary mb-15" to="#">
                      Tours de más Populares
                      <svg
                        width={16}
                        height={16}
                        viewBox="0 0 16 16"
                  ...
                  <div className="row">
                    <div className="col-6">
                      <div className="box-welcome-image-1">
                        {" "}
                        <img
                          src="/imgs/page/tour/HELI01posible2.jpg"
                          alt="Travile"
                        />
                        <img
                          src="/imgs/page/tour/Sin título-1.jpg"
                          alt="Travile"
                        />
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="box-welcome-image-2">
                        {" "}
                        <img src="/imgs/page/tour/el tigre.jpg" alt="Travile" />
                        <img
                          src="/imgs/page/tour/parrott_formation.jpg"
                          alt="Travile"
                        />
                      </div>
                    </div>
          ...
          <section className="section-box box-top-search-destination background-body">
            <div className="container">
              <div className="text-center wow fadeInUp">
                <h2 className="neutral-1000 wow fadeInUp">Más Tours...</h2>
                <p className="text-xl-medium neutral-500 wow fadeInUp">
                  Destinos favoritos de los turistas profesionales
                </p>
              </div>
                      ...
                      <div className="card-info">
                        ...
                        <div className="card-meta">
                          <div className="meta-links">
                            {" "}
                            <Link className="text-tour" to="/destination">
                              356 Tours
                            </Link>
                          </div>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/tour/Whale_Watching.jpg"
                          alt="Travila"
                          style={{ objectFit: "cover" }}
                        />
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="card-title" to="/destination">
                          Avistamiento de Ballenas y Delfines en Antiguas
                        </Link>
                        <div className="card-meta">
                          <div className="meta-links">
                            {" "}
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/tour/miradorflores.jpg"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="card-title" to="/destination">
                          Aventura en Helicóptero por el Mundo Maya <br></br>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/tour/Services_in_Antigua.jpg"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="card-title" to="/destination">
                          Tours Especiales y Servicios en Antigua
                        </Link>
                        <div className="card-meta">
                          <div className="meta-links">
                            {" "}
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/tour/Services_in_Belize.jpg"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="card-title" to="/destination">
                          Tours Especiales y Servicios en Belice
                        </Link>
                        <div className="card-meta">
                          <div className="meta-links">
                            {" "}
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/tour/Services_in_Atitlan.jpg"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                        {" "}
                        <Link className="card-title" to="/destination">
                          Tours Especiales y Servicios en el Lago de Atitlán
                        </Link>
                        <div className="card-meta">
                          <div className="meta-links">
                            {" "}
                    ...
                    <div className="col-lg-6 col-sm-6">
                      <div className="card-why card-why-2 background-1 wow fadeInUp">
                        <div className="card-image">
                          {" "}
                          <img
                            src="/imgs/page/homepage6/experience.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                  ...
                  <Swiper {...swiperGroupAnimate}>
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/homepage5/tour.png"
                            alt="Travila"
                          />
                        </div>
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          {" "}
                          <Link className="label bestsale" to="#">
                            Best Sale
                          </Link>
                          <Link className="wish" to="#">
                            <svg
                          ...
                          <img
                            src="/imgs/page/homepage5/tour2.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info background-card">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          {" "}
                          <Link className="label saleoff" to="#">
                            25% Off
                          </Link>
                          <Link className="wish" to="#">
                            <svg
                          ...
                          <img
                            src="/imgs/page/homepage5/tour3.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info background-card">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/homepage5/tour4.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info background-card">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/homepage1/journey2.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                            ...
                            <div className="card-location">
                              ...
                              <p className="text-star">
                                ...
                                <img
                                  ...
                                  src="/imgs/template/icons/star-black.svg"
                                  alt="Travila"
                                />
                                <img
                                  className="light-mode"
                                ...
                                <img
                                  className="dark-mode"
                                  src="/imgs/template/icons/star-w.svg"
                                  alt="Travila"
                                />
                                <img
                                  className="dark-mode"
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/homepage1/journey3.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/homepage1/journey4.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/destination/car.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/destination/car2.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/destination/car3.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img
                            src="/imgs/page/destination/car4.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="card-info">
