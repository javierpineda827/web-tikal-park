...
export default function ParkReg() {
  const { t } = useTranslation("ParkReg");
                      ...
                      <div>
                        <div className="card card-body pt-0">
                          ...
                          >
                            ...
                            <p>{t("article.paragraph_18")}</p>
                            <p>{t("article.paragraph_19")}</p>
                            <p>{t("article.paragraph_20")}</p>
                            <p>{t("article.paragraph_21")}</p>
                          </Trans>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="group-collapse-expand">
                      <div>
                        <div className="card card-body pt-0">
                          ...
                          >
                            <p>{t("article.paragraph_22")}</p>

                            <p>{t("article.paragraph_23")}</p>

                            <p>{t("article.paragraph_24")}</p>
                            <p>{t("article.paragraph_25")}</p>
                            <p>{t("article.paragraph_26")}</p>
                            <p>{t("article.paragraph_27")}</p>
                            <p>{t("article.paragraph_28")}</p>
                          </Trans>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="group-collapse-expand">
                      <div>
                        <div className="card card-body pt-0">
                          ...
                          >
                            <p>{t("article.paragraph_29")}</p>

                            <p>{t("article.paragraph_30")}</p>

                            <p>{t("article.paragraph_31")}</p>
                          </Trans>
                        </div>
                      </div>
                    </div>
