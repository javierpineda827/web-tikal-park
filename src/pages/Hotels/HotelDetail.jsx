                  ...
                  <Swiper {...swiperGroup1}>
                    <SwiperSlide>
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(/imgs/page/hotel/banner-hotel.png)",
                        }}
                      >
                ...
                <div className="col-lg-4 mb-20">
                  <div className="box-authors-partner background-9 wow fadeInUp">
                    <div className="authors-partner-left">
                      <img
                        src="/imgs/page/homepage5/author.png"
                        alt="Travila"
                      />
                      <img
                        src="/imgs/page/homepage5/author2.png"
                        alt="Travila"
                      />
                      <img
                        src="/imgs/page/homepage5/author3.png"
                        alt="Travila"
                      />
                    ...
                    <div className="list-numbers wow fadeInUp">
                      <div className="item-number">
                        <div className="image-top">
                          {" "}
                          <img
                            src="/imgs/page/hotel/airport.svg"
                            alt="Travila"
                          />
                        </div>
                      ...
                      <div className="item-number">
                        <div className="image-top">
                          {" "}
                          <img
                            src="/imgs/page/hotel/living.svg"
                            alt="Travila"
                          />
                        </div>
                        <p className="text-15-medium neutral-1000">
                      ...
                      <div className="item-number">
                        <div className="image-top">
                          {" "}
                          <img src="/imgs/page/hotel/front.svg" alt="Travila" />
                        </div>
                        <p className="text-15-medium neutral-1000">
                          Front desk (24-hour)
                        </p>
                      ...
                      <div className="item-number">
                        <div className="image-top">
                          {" "}
                          <img src="/imgs/page/hotel/wifi.svg" alt="Travila" />
                        </div>
                        <p className="text-15-medium neutral-1000">
                          Free Wifi <br />
                          Internet
                      ...
                      <div className="item-number">
                        <div className="image-top">
                          {" "}
                          <img src="/imgs/page/hotel/spa.svg" alt="Travila" />
                        </div>
                        <p className="text-15-medium neutral-1000">
                          Spa
                          <br />
              ...
              <div className="row align-items-center">
                ...
                <div className="col-lg-6 mb-30 text-center text-lg-end">
                  <div className="box-image-vision">
                    ...
                    <img
                      className="w-100"
                      src="/imgs/page/hotel/img-vision.png"
                      alt="Travila"
                    />
                    <div className="image-vision-1">
                      <img
                        className="w-100 mb-15"
                        src="/imgs/page/hotel/img-vision2.png"
                        alt="Travila"
                      />
                    </div>
                    <div className="image-vision-2">
                      <img
                        className="w-100"
                        src="/imgs/page/hotel/img-vision3.png"
                        alt="Travila"
                      />
                    </div>
                  </div>
                  ...
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room.png" alt="Travila" />
                      </Link>
                    </div>
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp">
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room2.png" alt="Travila" />
                      </Link>
                    </div>
                    <div className="card-info">
                      <div className="card-rating">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp">
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room3.png" alt="Travila" />
                      </Link>
                    </div>
                    <div className="card-info">
                      <div className="card-rating">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp">
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room4.png" alt="Travila" />
                      </Link>
                    </div>
                    <div className="card-info">
                      <div className="card-rating">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp">
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room5.png" alt="Travila" />
                      </Link>
                    </div>
                    <div className="card-info">
                      <div className="card-rating">
                ...
                <div className="col-lg-4 col-md-6 wow fadeInUp">
                  <div className="card-journey-small card-journey-small-type-3 background-card">
                    <div className="card-image">
                      ...
                      <Link href="/room-detail">
                        <img src="/imgs/page/hotel/room6.png" alt="Travila" />
                      </Link>
                    </div>
                    <div className="card-info">
                      <div className="card-rating">
                  ...
                  <div className="col-lg-7">
                    <div className="card-grid-video">
                      <div className="card-image">
                        ...
                        <img
                          className="mr-10"
                          src="/imgs/page/homepage7/img-video.png"
                          alt="Travile"
                        />
                      </div>
                      <div className="card-info">
                    ...
                    <div className="list-videos-small">
                      ...
                      <div className="item-video-small">
                        <div className="item-image">
                          ...
                          <img
                            className="mr-10"
                            src="/imgs/page/homepage7/img-video2.png"
                            alt="Travile"
                          />
                        </div>
                        <div className="item-info">
                      ...
                      <div className="item-video-small">
                        <div className="item-image">
                          ...
                          <img
                            className="mr-10"
                            src="/imgs/page/homepage7/img-video3.png"
                            alt="Travile"
                          />
                        </div>
                        <div className="item-info">
