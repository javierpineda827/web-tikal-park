          ...
          <section className="box-section box-breadcrumb background-body">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  {" "}
                  <Link to="/destination">Hotels</Link>
                  <span className="arrow-right">
                    <IconChevronRight width={7} height={12} />
                  </span>
                </li>
                <li>
                  {" "}
                  <Link to="/destination">
                    <span className="text-breadcrumb">Tikal</span>
                  </Link>
                </li>
              </ul>
            </div>
          ...
          <section className="section-box box-banner-hotel-detai-2">
            <div className="box-banner-hotel-detai-2-inner">
              <div className="container">
                ...
                <h2 className="color-white mb-20">
                  En dónde quedarse en el Parque Nacional Tikal, Flores, El
                  Remate o en sus alrededores
                </h2>
                <h6 className="color-white">
                  La Isla de Flores o El Remate también son buenos lugares para
                  alojarse cuando visite Tikal, sobre todo si tiene un vuelo
                  temprano o un traslado terrestre
                </h6>
              </div>
            </div>
          </section>
                ...
                <div className="box-grid-hotels box-list-hotels-detail wow fadeIn">
                  <div className="card-flight card-hotel background-card">
                    <div className="card-image">
                      ...
                      <Link to="/room-detail">
                        <img
                          src="/imgs/page/hotel/room1-Jungle-Lodge-StandardSingleKingBed.jpg"
                          alt="Travila"
                        />
                      </Link>
                    </div>
                      ...
                      <div className="card-hotel-2-col">
                        <div className="card-program">
                          <div className="card-tags">
                            {" "}
                            <Link className="btn btn-tag-border" to="#">
                              Transporte
                            </Link>
                            <Link className="btn btn-tag-border" to="#">
                          ...
                          <div className="card-hotel-desc">
                            <span className="text-md-medium neutral-500 t">
                              En el Jungle Lodge deberás tomar un paquete la
                              primera noche y puedes agregar las noches
                              adicionales que desees.
                            </span>
                          </div>
                        </div>
                        <div className="card-hotel-price">
                          <div className="box-hotel-price">
                            ...
                            <h4 className="price-main neutral-1000">$197.11</h4>
                  ...
                  <div className="card-flight card-hotel background-card">
                    <div className="card-image">
                      ...
                      <Link to="/room-detail-2">
                        <img
                          src="/imgs/page/hotel/room-isla-de-flores.jpg"
                          alt="Isla de flores"
                        />
                      </Link>
                    </div>
                    <div className="card-info">
                      ...
                      <div className="card-hotel-2-col">
                        <div className="card-program">
                          ...
                          <div className="card-hotel-desc">
                            <p className="text-md-medium neutral-500">
                              Una bonita isla con interesante arquitectura
                              caribeña, Flores es también una buena opción para
                              aquellos que quieran experimentar una ciudad y
                              vida nocturna en la región de Petén.
                            </p>
                          </div>
                        </div>
                        <div className="card-hotel-price">
                  ...
                  <div className="card-flight card-hotel background-card">
                    <div className="card-image">
                      ...
                      <Link to="/room-detail">
                        <img
                          src="/imgs/page/hotel/hotelRoom3.png"
                          alt="Travila"
                        />
                      </Link>
                    </div>
                  ...
                  <div className="card-flight card-hotel background-card">
                    <div className="card-image">
                      ...
                      <Link to="/room-detail-2">
                        <img
                          src="/imgs/page/hotel/hotelRoom4.png"
                          alt="Travila"
                        />
                      </Link>
                    </div>
                    <div className="card-info">
                      ...
                      <div className="card-title">
                        ...
                        <Link
                          ...
                          to="/room-detail-2"
                        >
                          Hoteles exclusivos en el área de Flores - Tikal
                        </Link>
                      </div>
                      <div className="card-hotel-2-col">
                        <div className="card-program">
                  ...
                  <div className="card-flight card-hotel background-card">
                    <div className="card-image">
                      ...
                      <Link to="/room-detail">
                        <img
                          src="/imgs/page/hotel/hotelRoom5.png"
                          alt="Travila"
                        />
                      </Link>
                    </div>
                      ...
                      <div className="row align-items-center">
                        <div className="col-sm-4 mb-30">
                          <img
                            ...
                            src="/imgs/page/homepage2/payment.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="col-sm-4 mb-30">
                          <img
                            ...
                            src="/imgs/page/homepage2/payment2.png"
                            alt="Travila"
                          />
                          <img
                            className="bdrd8 w-100 mb-15"
                            src="/imgs/page/homepage2/payment3.png"
                            alt="Travila"
                          />
                        </div>
                        <div className="col-sm-4 mb-30">
                          <img
                            className="bdrd8 w-100"
                            src="/imgs/page/homepage2/payment4.png"
                            alt="Travila"
                          />
                          <img
                            className="bdrd8 w-100"
                            src="/imgs/page/homepage2/payment5.png"
                            alt="Travila"
                          />
                        </div>
                      </div>
