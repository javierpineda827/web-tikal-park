            ...
            <div className="container">
              <div className="text-center">
                ...
                <div className="d-flex align-items-center justify-content-center mt-45">
                  <Link className="btn btn-black-lg-square" to="/">
                    <svg
                      className="first"
                      width={16}
                      height={16}
                  ...
                  <div className="card-contact">
                    ...
                    <div className="card-info">
                      <div className="card-title">
                        {" "}
                        <Link className="title text-lg-bold" to="/">
                          Support Forum
                        </Link>
                      ...
                      <div className="card-method-contact">
                        {" "}
                        <Link className="email text-md-bold" to="/">
                          Details
                          <svg
                            width={16}
                            height={16}
          ...
          <section className="section-box box-news box-news-2 background-9">
            ...
            <div className="container-slider box-swiper-padding">
              <div className="box-list-news">
                ...
                <div className="mt-40">
                  <Link className="btn btn-black-lg" to="/blog-detail">
                    View More
                    <svg
                      width={16}
                      height={16}
