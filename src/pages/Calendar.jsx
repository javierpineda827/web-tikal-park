                ...
                <div className="col-lg-8">
                  <div className="box-collapse-expand">
                    ...
                    <div className="group-collapse-expand">
                      <div>
                        <div className="card card-body pt-0">
                          ...
                          <Figure className="mx-4 my-4">
                            <FigureImage src={t("article.fig_img_3")} />
                            <FigureCaption>
                              <p>{t("article.fig_caption_3")}</p>
                            </FigureCaption>
                          </Figure>
                          ...
                          <Figure className="mx-4 my-4">
                            <FigureImage src={t("article.fig_img_4")} />
                            <FigureCaption>
                              <p>{t("article.fig_caption_4")}</p>
                            </FigureCaption>
                          </Figure>
                      ...
                      <Figure className="mx-4 my-4">
                        <FigureImage src={t("article.fig_img_5")} />
                        <FigureCaption>
                          <p>{t("article.fig_caption_5")}</p>
                        </FigureCaption>
                      </Figure>
                    </div>
                  </div>
