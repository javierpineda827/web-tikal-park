                    ...
                    <div className="box-content-info-detail mt-0 pt-0">
                      ...
                      <div className="content-detail-post">
                        <p>
                          ...
                          memories. From hidden paradises to cultural gems, let
                          & s embark on an odyssey of exploration and discovery.
                        </p>
                        ...
                        <li>
                          <div className="card-post">
                            <div className="card-image">
                              ...
                              <Link to="/explores">
                                <img
                                  src="/imgs/page/art/explorers.jpg"
                                  alt="Travila"
                                  width={72}
                                  height={80}
                                />
                            ...
                            <div className="card-info">
                              ...
                              <Link
                                ...
                                to="/blog-detail-2"
                              >
                                Tikal y los primeros exploradores
                              </Link>
                      ...
                      <SwiperSlide>
                        <div className="card-news background-card hover-up">
                          <div className="card-image">
                            ...
                            <img
                              src="/imgs/page/homepage1/news.png"
                              alt="Travila"
                            />
                          </div>
                          <div className="card-info">
                            ...
                            <div className="card-program">
                              <div className="endtime">
                                <div className="card-author">
                                  {" "}
                                  <img
                                    src="/imgs/page/homepage1/avatar.png"
                                    alt="Travila"
                                  />
                                  <p className="text-sm-bold neutral-1000">
                                    Jimmy Dave
                      ...
                      <SwiperSlide>
                        <div className="card-news background-card hover-up">
                          <div className="card-image">
                            ...
                            <img
                              src="/imgs/page/homepage1/news2.png"
                              alt="Travila"
                            />
                          </div>
                          <div className="card-info">
                      ...
                      <SwiperSlide>
                        <div className="card-news background-card hover-up">
                          <div className="card-image">
                            ...
                            <img
                              src="/imgs/page/homepage1/news3.png"
                              alt="Travila"
                            />
                          </div>
                          <div className="card-info">
