              ...
              <ul className="breadcrumbs">
                ...
                <li>
                  ...
                  <span className="text-breadcrumb">
                    TOUR DE UN DIA DE TIKAL DESDE FLORES O EL AEROPUERTO MUNDO
                    MAYA
                  </span>
                </li>
              </ul>
              ...
              <div className="row">
                <div className="col-md-6 order-lg-2">
                  <div className="destination-banner-3 mb-20">
                    <Link className="image-gallery" href="#">
                      <img
                        src="/imgs/page/destination/banner8.png"
                        alt="Travile"
                      />
                    </Link>
                  </div>
                  <div className="row">
                    <div className="col-6">
                      <div className="destination-banner-4 mb-20">
                        <Link className="image-gallery" href="#">
                          <img
                            src="/imgs/page/destination/banner9.png"
                            alt="Travile"
                          />
                        </Link>
                      </div>
                    ...
                    <div className="col-6">
                      <div className="destination-banner-5 mb-20">
                        <Link className="image-gallery" href="#">
                          <img
                            src="/imgs/page/destination/banner10.png"
                            alt="Travile"
                          />
                        </Link>
                      </div>
                ...
                <div className="col-md-3 col-6 order-lg-1">
                  <div className="destination-banner-1 mb-20">
                    <Link className="image-gallery" href="#">
                      <img
                        src="/imgs/page/destination/banner6.png"
                        alt="Travile"
                      />
                    </Link>
                  </div>
                  <div className="destination-banner-2 mb-20">
                    ...
                    <Link className="image-gallery" href="#">
                      <img
                        src="/imgs/page/destination/banner7png"
                        alt="Travile"
                      />
                    </Link>
                  </div>
                ...
                <div className="col-md-3 col-6 order-lg-3">
                  <div className="destination-banner-6 mb-20">
                    <Link className="image-gallery" href="#">
                      <img
                        src="/imgs/page/destination/banner11.png"
                        alt="Travile"
                      />
                    </Link>
                  </div>
                  <div className="destination-banner-7 mb-20">
                    ...
                    <Link className="image-gallery" href="#">
                      <img
                        src="/imgs/page/destination/banner12.png"
                        alt="Travile"
                      />
                    </Link>
                  </div>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels.png"
                          alt="Travila"
                        />
                      </div>
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels2.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels3.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels4.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels5.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels6.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels7.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                  ...
                  <div className="col-lg-3 col-sm-6">
                    <div className="card-popular card-top-destination background-card wow fadeInUp">
                      <div className="card-image">
                        {" "}
                        <img
                          src="/imgs/page/homepage6/hotels8.png"
                          alt="Travila"
                        />
                      </div>
                      <div className="card-info">
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img src="/imgs/page/hotels/car.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-rating">
                            <div className="card-left"> </div>
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img src="/imgs/page/hotels/car2.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-rating">
                            <div className="card-left"> </div>
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img src="/imgs/page/hotels/car3.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-rating">
                            <div className="card-left"> </div>
                    ...
                    <SwiperSlide>
                      <div className="card-journey-small background-card">
                        <div className="card-image">
                          ...
                          <img src="/imgs/page/hotels/car4.png" alt="Travila" />
                        </div>
                        <div className="card-info">
                          <div className="card-rating">
                            <div className="card-left"> </div>
