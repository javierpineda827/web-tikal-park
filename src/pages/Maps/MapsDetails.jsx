                ...
                <div className="box-banner-activities">
                  ...
                  >
                    <div className="banner-slide-activity">
                      <img
                        src="/imgs/page/activities/banner.png"
                        alt="Travila"
                      />
                    </div>
                    <div className="banner-slide-activity">
                ...
                <div className="slider-thumnail-activities">
                  ...
                  >
                    <div className="banner-slide">
                      <img src="/imgs/page/homepage2/thumb.png" alt="Travila" />
                    </div>
                    <div className="banner-slide">
                      <img
                        src="/imgs/page/homepage2/thumb2.png"
                        alt="Travila"
                      />
                    </div>
                    <div className="banner-slide">
                      <img
                        src="/imgs/page/homepage2/thumb3.png"
                        alt="Travila"
                      />
                    </div>
                    <div className="banner-slide">
              ...
              <div className="row mt-30">
                          ...
                          <div className="head-reviews">
                            <div className="review-left">
                              <div className="review-info-inner">
                                ...
                                <div className="review-rate">
                                  {" "}
                                  <img
                                    src="/imgs/page/tour-detail/star.svg"
                                    alt="Travila"
                                  />
                                  <img
                                    src="/imgs/page/tour-detail/star.svg"
                            ...
                            <div className="review-right">
                              <div className="review-progress">
                                ...
                                <div className="item-review-progress">
                                  <div className="text-rv-progress">
                                    <p className="text-sm-bold">Ayuda</p>
                                  </div>
                                  <div className="bar-rv-progress">
                                    <div className="progress">
                                      <div
                ...
                <div className="col-lg-4">
                  ...
                  <div className="sidebar-banner">
                    ...
                    <Link href="#">
                      <img
                        src="/imgs/page/tour-detail/banner-ads.png"
                        alt="Travila"
                      />
                    </Link>
                  </div>
                  <div className="sidebar-banner">
                    ...
                    <Link href="#">
                      <img
                        src="/imgs/page/tour-detail/banner-ads2.png"
                        alt="Travila"
                      />
                    </Link>
                  </div>
