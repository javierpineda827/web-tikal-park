              ...
              <div className="tour-header">
                ...
                <div className="tour-metas">
                  <div className="tour-meta-left">
                    ...
                    <Link className="text-md-medium neutral-1000 mr-30" to="#">
                      Show on map
                    </Link>
                    ...
                    <Link className="text-md-medium neutral-1000" to="#">
                      LVA-4125
                    </Link>
                  </div>
                  <div className="tour-meta-right">
                    {" "}
                    <Link className="btn btn-share" to="#">
                      <svg
                        width={16}
                        height={18}
                        viewBox="0 0 16 18"
                    ...
                    <Link className="btn btn-wishlish" to="#">
                      <svg
                        width={20}
                        height={18}
                        viewBox="0 0 20 18"
